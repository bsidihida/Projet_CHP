...
public:
// Gradient2(bitpit::VolumeKernel *grid, interpo_type iType) {
Gradient2(int dim, Grid *grid, StencilBuilder* stencil = nullptr);
~Gradient2() {
}
...
//std::vector<std::array<double,3> >   computeFVdiffusion(PiercedVector<double> &val);
 ...
 *
 * @return Gradient2 as a pierced vector
 */
...
PiercedVector<double > computeFVDiffusion(
