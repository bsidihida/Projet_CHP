 ...
 */
void computeCorrection(Solution& solNext,PiercedVector<double> phiFC, PiercedVector<double> phiCC);
...
PiercedVector<double> _psi; 
PiercedVector<double> _rhocc; 
PiercedVector<double> _rhofc; 
};
}
