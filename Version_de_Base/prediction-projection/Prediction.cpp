                                       ...
                                       Solution& solNext)
{
  ...
  {
    kappaFC.emplace(inter.getId()); // interId donne l'indice des faces
    kappaFC[inter.getId()] = 1.; // dont on a besoin, à changer avec un coefficient variable en temps et en espace
  }
